...
| 5.9  | **Open decision — resolve before building:** exactly how Gmail invites are sent/validated isn't pinned down anywhere in the docs. Decide the mechanics (who triggers an invite, what the invite link contains, expiry) | **You decide with the agent**, then log it in `decision-log.md`, then agent builds it                                                                |
...
| 5.15 | Full manual run-through: request access → admin approves → login → edit profile, for at least a student and an admin account                                                                                           | **You**                                                                                                                                              |
